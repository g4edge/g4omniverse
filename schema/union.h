...
//
#ifndef G4_GENERATED_UNION_H
#define G4_GENERATED_UNION_H
...
public:
    ...
    /// Construct a G4Union on UsdPrim \p prim .
    /// Equivalent to G4Union::Get(prim.GetStage(), prim.GetPath())
    ...
    /// Construct a G4Union on the prim held by \p schemaObj .
    ...
    /// Return a G4Union holding the prim adhering to this
    /// schema at \p path on \p stage.  If no prim exists at \p path on
    /// \p stage, or if the prim at that path does not adhere to this schema,
    /// return an invalid schema object.  This is shorthand for the following:
    ///
    /// \code
    /// G4Union(stage->GetPrimAtPath(path));
    /// \endcode
    ///
    G4_API
    static G4Union
...
public:
    ...
    /// | ||
    /// | -- | -- |
    /// | Declaration | `string g4type = "Union"` |
    /// | C++ Type | std::string |
